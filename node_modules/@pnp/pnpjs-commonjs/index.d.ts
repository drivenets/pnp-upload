import { Logger } from "@pnp/logging-commonjs";
import { PnPClientStorage, dateAdd, combine, getCtxCallback, getRandomString, getGUID, isFunc, objectDefinedNotNull, isArray, assign, isUrlAbsolute, stringIsNullOrEmpty, sanitizeGuid } from "@pnp/common-commonjs";
...
import "@pnp/sp-commonjs/presets/all";
import "@pnp/graph-commonjs/presets/all";
/**
 * Re-export everything from the dependencies to match the previous pattern
 */
export * from "@pnp/common-commonjs";
export * from "@pnp/logging-commonjs";
export * from "@pnp/config-store";
export * from "@pnp/odata-commonjs";
 ...
 * Provides access to the SharePoint REST interface
 */
export declare const graph: import("@pnp/graph-commonjs").GraphRest;
/**
...
declare const Def: {
     ...
     */
    graph: import("@pnp/graph-commonjs").GraphRest;
    /**
     * Global logging instance to which subscribers can be registered and messages written
     */
    log: typeof Logger;
