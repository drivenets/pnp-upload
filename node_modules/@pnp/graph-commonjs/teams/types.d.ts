...
export declare const Team: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => ITeam & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Teams
 */
...
export declare const Teams: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => ITeams & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Channel
 */
...
export declare const Channel: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => IChannel & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Channels
 */
...
export declare const Channels: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => IChannels & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Tab
 */
...
export declare const Tab: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => ITab & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Tabs
 */
...
export declare const Tabs: (baseUrl: string | import("../graphqueryable").IGraphQueryable<any>, path?: string) => ITabs & import("@pnp/odata-commonjs").IInvokable<any>;
