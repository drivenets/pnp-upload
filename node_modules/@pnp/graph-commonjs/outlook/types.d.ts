import { _GraphQueryableCollection, _GraphQueryableInstance } from "@pnp/graph-commonjs/graphqueryable";
import { OutlookUser as IOutlookType, OutlookCategory as IOutlookCategoryType } from "@microsoft/microsoft-graph-types";
import { IDeleteable, IGetById, IUpdateable } from "@pnp/graph-commonjs/decorators";
/**
 * Outlook
 */
...
export declare const Outlook: (baseUrl: string | import("@pnp/graph-commonjs").IGraphQueryable<any>, path?: string) => IOutlook & import("@pnp/odata-commonjs").IInvokable<any>;
/**
...
export declare const OutlookCategory: (baseUrl: string | import("@pnp/graph-commonjs").IGraphQueryable<any>, path?: string) => IOutlookCategory & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Categories
 */
...
export declare const MasterCategories: (baseUrl: string | import("@pnp/graph-commonjs").IGraphQueryable<any>, path?: string) => IMasterCategories & import("@pnp/odata-commonjs").IInvokable<any>;
/**
