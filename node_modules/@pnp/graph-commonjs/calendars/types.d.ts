...
export declare const Calendar: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => ICalendar & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Calendars
 */
...
export declare const Calendars: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => ICalendars & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Event
 */
...
export declare const Event: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IEvent & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Events
 */
...
export declare const Events: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IEvents & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * EventAddResult
 */
