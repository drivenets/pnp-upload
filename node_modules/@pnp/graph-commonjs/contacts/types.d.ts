...
export declare const Contact: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IContact & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Contacts
 */
...
export declare const Contacts: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IContacts & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Contact Folder
 */
...
export declare const ContactFolder: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IContactFolder & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Contact Folders
 */
...
export declare const ContactFolders: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IContactFolders & import("@pnp/odata-commonjs").IInvokable<any>;
/**
