...
export declare const OneNote: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IOneNote & import("@pnp/odata-commonjs").IInvokable<any>;
/**
...
export declare const Notebook: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => INotebook & import("@pnp/odata-commonjs").IInvokable<any>;
/**
...
export declare const Notebooks: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => INotebooks & import("@pnp/odata-commonjs").IInvokable<any>;
/**
...
export declare const Section: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => ISection & import("@pnp/odata-commonjs").IInvokable<any>;
/**
...
export declare const Sections: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => ISections & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * INotebookAddResult
 */
