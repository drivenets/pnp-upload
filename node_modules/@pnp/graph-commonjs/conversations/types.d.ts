...
export declare const Conversation: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IConversation & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Conversations
 */
...
export declare const Conversations: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IConversations & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Thread
 */
...
export declare const Thread: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IThread & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Threads
 */
...
export declare const Threads: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IThreads & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Post
 */
...
export declare const Post: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IPost & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Posts
 */
...
export declare const Posts: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IPosts & import("@pnp/odata-commonjs").IInvokable<any>;
/**
 * Senders
 */
...
export declare const Senders: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => ISenders & import("@pnp/odata-commonjs").IInvokable<any>;
/**
