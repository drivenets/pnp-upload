...
var GraphBatch = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(GraphBatch, _super);
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        client = new graphhttpclient_js_1.GraphHttpClient(this.runtime);
                            ...
                            return (0, tslib_1.__generator)(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        batchOptions = {
                                            body: (0, common_1.jsS)(batchRequest),
                                            headers: {
                                        ...
                                        return [4 /*yield*/, (0, toabsoluteurl_js_1.toAbsoluteUrl)(this_1.batchUrl, this_1.runtime)];
                                    case 1:
                                        queryUrl = _b.sent();
    ...
    GraphBatch.prototype.formatRequests = function (requests) {
        ...
        return requests.map(function (reqInfo, index) {
            ...
            headers = (0, common_1.assign)(headers, (_a = _this.runtime.get("graph")) === null || _a === void 0 ? void 0 : _a.headers);
            if (reqInfo.options !== undefined) {
                // merge per request headers
                if (reqInfo.options.headers !== undefined && reqInfo.options.headers !== null) {
                    headers = (0, common_1.assign)(headers, reqInfo.options.headers);
                }
                ...
                if (reqInfo.options.body !== undefined && reqInfo.options.body !== null) {
                    ...
                    requestFragment = (0, common_1.assign)(requestFragment, {
    ...
    GraphBatch.prototype.parseResponse = function (requests, graphResponse) {
        return new Promise(function (resolve, reject) {
            ...
            if ((0, common_1.hOP)(graphResponse, "error")) {
