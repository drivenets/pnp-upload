...
import { SharePointServicePrincipal } from "./types.js";
...
export function validateProviderHostedRequestToken(requestToken, clientSecret) {
 ...
 */
export function getAddInOnlyAccessToken(siteUrl, clientId, clientSecret, realm, stsUri) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function getUserAccessToken(siteUrl, clientId, clientSecret, refreshToken, realm, stsUri, cacheKey) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    resource = getFormattedPrincipal(SharePointServicePrincipal, parse(params.siteUrl).hostname, params.realm);
