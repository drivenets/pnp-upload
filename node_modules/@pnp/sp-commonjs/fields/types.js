...
var _Fields = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(_Fields, _super);
    function _Fields() {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        postBody = (0, odata_1.body)({
                            "parameters": (0, common_1.assign)((0, metadata_js_1.metadata)("SP.XmlSchemaFieldCreationInformation"), xml),
                        });
                        return [4 /*yield*/, (0, operations_js_1.spPost)(this.clone(exports.Fields, "createfieldasxml"), postBody)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, {
                                data: data,
   ...
   */
    _Fields.prototype.getById = function (id) {
        return telemetry_js_1.tag.configure((0, exports.Field)(this).concat("('" + id + "')"), "fs.getById");
    };
    /**
   ...
   */
    _Fields.prototype.getByTitle = function (title) {
        return telemetry_js_1.tag.configure((0, exports.Field)(this, "getByTitle('" + title + "')"), "fs.getByTitle");
    };
    /**
   ...
   */
    _Fields.prototype.getByInternalNameOrTitle = function (name) {
        return telemetry_js_1.tag.configure((0, exports.Field)(this, "getByInternalNameOrTitle('" + name + "')"), "fs.getByInternalNameOrTitle");
    };
    /**
    ...
    _Fields.prototype.add = function (title, fieldType, properties) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postBody = (0, odata_1.body)(Object.assign((0, metadata_js_1.metadata)(fieldType), {
                            "Title": title,
                        }, properties));
                        if (!telemetry_js_1.tag.isTagged(this)) {
                            telemetry_js_1.tag.configure(this, "fs.add");
                        }
                        return [4 /*yield*/, (0, operations_js_1.spPost)(this.clone(exports.Fields, null), postBody)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, {
                                data: data,
   ...
   */
    _Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (minValue !== undefined) {
            props = (0, common_1.assign)({ MinimumValue: minValue }, props);
        }
        if (maxValue !== undefined) {
            props = (0, common_1.assign)({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", (0, common_1.assign)(props, properties));
    };
  ...
  */
    _Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", (0, common_1.assign)(props, properties));
    };
    /**
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        postBody = (0, odata_1.body)({
                            "parameters": (0, common_1.assign)((0, metadata_js_1.metadata)("SP.FieldCreationInformation"), props),
                        });
                        return [4 /*yield*/, (0, operations_js_1.spPost)(this.clone(exports.Fields, "addfield"), postBody)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, {
                                data: data,
   ...
   */
    _Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", (0, common_1.assign)(props, properties));
    };
    /**
   ...
   */
    _Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", (0, common_1.assign)(props, properties));
    };
    /**
  ...
  */
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, operations_js_1.spPost)(this.clone(exports.Fields, path))];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, {
                                data: data,
    ...
    _Fields.prototype.addLocation = function (title, properties) {
        ...
        return this.add(title, "SP.FieldLocation", (0, common_1.assign)(props, properties));
    };
    /**
     * Adds a new SP.FieldLocation to the collection
     *
    ...
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.createFieldAsXml")
    ], _Fields.prototype, "createFieldAsXml", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addText")
    ], _Fields.prototype, "addText", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addCalculated")
    ], _Fields.prototype, "addCalculated", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addDateTime")
    ], _Fields.prototype, "addDateTime", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addNumber")
    ], _Fields.prototype, "addNumber", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addCurrency")
    ], _Fields.prototype, "addCurrency", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addMultilineText")
    ], _Fields.prototype, "addMultilineText", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addUrl")
    ], _Fields.prototype, "addUrl", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addUser")
    ], _Fields.prototype, "addUser", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addLookup")
    ], _Fields.prototype, "addLookup", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addChoice")
    ], _Fields.prototype, "addChoice", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addMultiChoice")
    ], _Fields.prototype, "addMultiChoice", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addBoolean")
    ], _Fields.prototype, "addBoolean", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addDependentLookupField")
    ], _Fields.prototype, "addDependentLookupField", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addLocation")
    ], _Fields.prototype, "addLocation", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("fs.addImage")
    ], _Fields.prototype, "addImageField", null);
    _Fields = (0, tslib_1.__decorate)([
        (0, decorators_js_1.defaultPath)("fields")
    ], _Fields);
    return _Fields;
}(sharepointqueryable_js_1._SharePointQueryableCollection));
exports._Fields = _Fields;
exports.Fields = (0, sharepointqueryable_js_1.spInvokableFactory)(_Fields);
var _Field = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(_Field, _super);
    function _Field() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.delete = (0, sharepointqueryable_js_1.deleteable)("f");
        return _this;
    }
    /**
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, exports.Field)(this).select("FieldTypeKind").configure({
                                headers: {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        req = (0, odata_1.body)((0, common_1.assign)((0, metadata_js_1.metadata)(fieldType), properties), (0, odata_1.headers)({ "X-HTTP-Method": "MERGE" }));
                        return [4 /*yield*/, (0, operations_js_1.spPost)(this, req)];
                    case 3:
                        data = _a.sent();
                        return [2 /*return*/, {
                                data: data,
   ...
   */
    _Field.prototype.setShowInDisplayForm = function (show) {
        return (0, operations_js_1.spPost)(this.clone(exports.Field, "setshowindisplayform(" + show + ")"));
    };
    /**
   * Sets the value of the ShowInEditForm property for this field.
   */
    _Field.prototype.setShowInEditForm = function (show) {
        return (0, operations_js_1.spPost)(this.clone(exports.Field, "setshowineditform(" + show + ")"));
    };
    /**
   * Sets the value of the ShowInNewForm property for this field.
   */
    _Field.prototype.setShowInNewForm = function (show) {
        return (0, operations_js_1.spPost)(this.clone(exports.Field, "setshowinnewform(" + show + ")"));
    };
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("f.update")
    ], _Field.prototype, "update", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("f.setShowInDisplayForm")
    ], _Field.prototype, "setShowInDisplayForm", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("f.setShowInEditForm")
    ], _Field.prototype, "setShowInEditForm", null);
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("f.setShowInNewForm")
    ], _Field.prototype, "setShowInNewForm", null);
    return _Field;
}(sharepointqueryable_js_1._SharePointQueryableInstance));
exports._Field = _Field;
exports.Field = (0, sharepointqueryable_js_1.spInvokableFactory)(_Field);
/**
