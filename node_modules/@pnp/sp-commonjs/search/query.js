...
exports.SearchResults = exports.Search = exports._Search = exports.SearchQueryBuilder = void 0;
...
var _Search = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(_Search, _super);
    function _Search() {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        postBody = (0, odata_1.body)({
                            request: (0, common_1.assign)((0, metadata_js_1.metadata)("Microsoft.Office.Server.Search.REST.SearchRequest"), Object.assign({}, query, {
                        ...
                        if (this.data.useCaching) {
                            ...
                            cacheKey = "PnPjs.SearchWithCaching(" + (0, common_1.getHashCode)(postBody.body) + ")";
                            if ((0, common_1.objectDefinedNotNull)(this.data.cachingOptions)) {
                                // if our key ends in the postquery url we overwrite it
                                if ((0, common_1.stringIsNullOrEmpty)(this.data.cachingOptions.key) || queryRegex.test(this.data.cachingOptions.key)) {
    ...
    _Search.prototype.fixArrProp = function (prop) {
        ...
        return { results: (0, common_1.isArray)(prop) ? prop : [prop] };
    };
    /**
    ...
    (0, tslib_1.__decorate)([
        (0, telemetry_js_1.tag)("se.execute")
    ], _Search.prototype, "execute", null);
    _Search = (0, tslib_1.__decorate)([
        (0, decorators_js_1.defaultPath)("_api/search/postquery")
    ], _Search);
    return _Search;
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var rows = pageSize !== undefined ? pageSize : (0, common_1.hOP)(this._query, "RowLimit") ? this._query.RowLimit : 10;
        var query = (0, common_1.assign)(this._query, {
            RowLimit: rows,
        ...
        return (0, exports.Search)(this._url)(query);
    };
    /**
    ...
    SearchResults.prototype.formatSearchResults = function (rawResults) {
        ...
        try {
            for (var tempResults_1 = (0, tslib_1.__values)(tempResults), tempResults_1_1 = tempResults_1.next(); !tempResults_1_1.done; tempResults_1_1 = tempResults_1.next()) {
