...
import { IConfigOptions } from "@pnp/common-commonjs";
...
export declare const Suggest: (baseUrl: string | ISharePointQueryable, options?: IConfigOptions, runtime?: import("@pnp/common-commonjs").Runtime) => ISuggest;
/**
