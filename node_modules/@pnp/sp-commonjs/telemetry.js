        ...
        descriptor.value = function () {
            ...
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                return (0, tslib_1.__generator)(this, function (_a) {
                    this.configure((0, odata_1.headers)({ "X-PnPjs-Tracking": name }));
...
tag.getClientTag = function (h, deleteFromCollection) {
    ...
    if (h.has("X-PnPjs-Tracking")) {
        ...
        if (!(0, common_1.stringIsNullOrEmpty)(methodName)) {
            return methodName;
        }
    }
    return "";
...
tag.configure = function (o, name) {
    return o.configure((0, odata_1.headers)({ "X-PnPjs-Tracking": name }));
};
