...
exports.SPFxAdalClient = exports.LambdaFetchClient = exports.BearerTokenFetchClient = exports.FetchClient = exports.getADALResource = exports.mergeOptions = exports.mergeHeaders = void 0;
var tslib_1 = require("tslib");
var util_js_1 = require("./util.js");
var safe_global_js_1 = require("./safe-global.js");
function mergeHeaders(target, source) {
    if ((0, util_js_1.objectDefinedNotNull)(source)) {
...
function mergeOptions(target, source) {
    if ((0, util_js_1.objectDefinedNotNull)(source)) {
        var headers = (0, util_js_1.assign)(target.headers || {}, source.headers);
        target = (0, util_js_1.assign)(target, source);
...
var FetchClient = /** @class */ (function () {
    ...
    FetchClient.prototype.fetch = function (url, options) {
        return safe_global_js_1.safeGlobal.fetch(url, options);
    };
    return FetchClient;
}());
...
var BearerTokenFetchClient = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(BearerTokenFetchClient, _super);
...
var LambdaFetchClient = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(LambdaFetchClient, _super);
...
exports.LambdaFetchClient = LambdaFetchClient;
/**
 * Client wrapping the aadTokenProvider available from SPFx >= 1.6
 */
var SPFxAdalClient = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(SPFxAdalClient, _super);
    /**
     *
     * @param context provide the appropriate SPFx Context object
     */
    function SPFxAdalClient(context) {
        var _this = _super.call(this, function (params) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var provider;
