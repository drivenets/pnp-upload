...
var libconfig_js_1 = require("./libconfig.js");
/**
...
var PnPClientStorageWrapper = /** @class */ (function () {
    ...
    function PnPClientStorageWrapper(store, defaultTimeoutMinutes) {
        ...
        if (libconfig_js_1.DefaultRuntime.get("enableCacheExpiration")) {
    ...
    PnPClientStorageWrapper.prototype.createPersistable = function (o, expire) {
        if (expire === undefined) {
            ...
            var defaultTimeout = libconfig_js_1.DefaultRuntime.get("defaultCachingTimeoutSeconds");
            if (this.defaultTimeoutMinutes > 0) {
                defaultTimeout = this.defaultTimeoutMinutes * 60;
            }
            expire = (0, util_js_1.dateAdd)(new Date(), "second", defaultTimeout);
        }
        return (0, util_js_1.jsS)({ pnp: 1, expiration: expire, value: o });
    };
    /**
    ...
    PnPClientStorageWrapper.prototype.cacheExpirationHandler = function () {
        ...
        this.deleteExpired().then(function () {
            ...
            setTimeout((0, util_js_1.getCtxCallback)(_this, _this.cacheExpirationHandler), libconfig_js_1.DefaultRuntime.get("cacheExpirationIntervalMilliseconds"));
        }).catch(console.error);
    };
