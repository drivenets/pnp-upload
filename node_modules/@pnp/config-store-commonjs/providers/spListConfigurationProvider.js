...
var cachingConfigurationProvider_js_1 = require("./cachingConfigurationProvider.js");
require("@pnp/sp-commonjs/lists/web");
require("@pnp/sp-commonjs/items/list");
/**
...
var SPListConfigurationProvider = /** @class */ (function () {
    ...
    SPListConfigurationProvider.prototype.asCaching = function (cacheKey) {
        ...
        return new cachingConfigurationProvider_js_1.default(this, cacheKey);
    };
