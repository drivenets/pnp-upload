...
exports.SPRequestExecutorClient = void 0;
...
var SPRequestExecutorClient = /** @class */ (function () {
    ...
    SPRequestExecutorClient.prototype.fetch = function (url, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (options.body) {
                requestOptions = (0, common_1.assign)(requestOptions, { body: options.body });
            }
            else {
                requestOptions = (0, common_1.assign)(requestOptions, { binaryStringRequestBody: true });
            }
